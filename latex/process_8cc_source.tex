...
\doxymbox{\hyperlink{process_8cc}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00024}00024\ \textcolor{preprocessor}{\#include\ "{}\doxymbox{\hyperlink{pixie_8hh}{pixie.hh}}"{}}}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00025}00025\ \textcolor{preprocessor}{\#include\ "{}\doxymbox{\hyperlink{traces_8hh}{traces.hh}}"{}}}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00028}00028\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespace_p_i_x_i_e}{PIXIE}}\ \{\ \ }
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00029}\doxymbox{\hyperlink{namespace_p_i_x_i_e_ad864ab63e26cb252877ab4d1c8acd85b}{00029}}\ \ \ \textcolor{keywordtype}{void}\ *\doxymbox{\hyperlink{namespace_p_i_x_i_e_ad864ab63e26cb252877ab4d1c8acd85b}{Process}}(\textcolor{keywordtype}{void}\ *thread)\ \{}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00030}00030\ \ \ \ \ \doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader}{PIXIE::Reader}}\ *reader\ \ \ \ \ \ \ \ \ \ \ \ =\ \&(((PixieThread*)thread)\ -\/>\ reader);}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00031}00031\ \ \ \ \ options\ options\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ =\ ((PixieThread*)thread)\ -\/>\ opt;}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00032}00032\ \ \ \ \ \doxymbox{\hyperlink{class_p_i_x_i_e_1_1_experiment___definition}{Experiment\_Definition}}\ definition\ =\ ((PixieThread*)thread)\ -\/>\ definition;}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00065}00065\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\ \&crate\_it\ :\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_abb0fc6333195ac9dd12f7fea78834b0f}{definition}}.\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_experiment___definition_aabcea4cb8a3eb1e2b3185f108256b43d}{crateMap}})\ \{}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00128}00128\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{class_p_i_x_i_e_1_1_trace_1_1_measurement}{PIXIE::Trace::Measurement}}\ meas\ =\ trace\_meas[i];}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00129}00129\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ tree-\/>Branch((branchName+\textcolor{stringliteral}{"{}."{}}+meas.\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_trace_1_1_measurement_a5fa417f5be604f7a14ab8e6d8f521be5}{name}}).c\_str(),\ \&(tracedata-\/>meas[i]));}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00174}00174\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (options.breakatevent\ >\ 0\ \&\&\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a59724abfa68ca0b7a4225a66a636e1d1}{eventsread}}\ +\ options.events\_per\_read\ >\ options.breakatevent)\{}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00175}00175\ \ \ \ \ reader\ -\/>\ read(new\_events,\ options.coincWindow,\ options.breakatevent\ -\/\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a59724abfa68ca0b7a4225a66a636e1d1}{eventsread}},\ max\_offset,\ options.warnings);}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00180}00180\ \ \ \ \ \ \ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a59724abfa68ca0b7a4225a66a636e1d1}{eventsread}}\ =\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a59724abfa68ca0b7a4225a66a636e1d1}{eventsread}}\ +\ new\_events.size();}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00197}00197\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \&meas\ :\ event.fMeasurements)\ \{}
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00198}00198\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{auto}\ *channel\ =\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_abb0fc6333195ac9dd12f7fea78834b0f}{definition}}.\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_experiment___definition_a4dafec217c0b9f571c8cc9e944e3f050}{GetChannel}}(meas.crateID,\ meas.slotID,\ meas.channelNumber);}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00275}00275\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (options.breakatevent\ \&\&\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a59724abfa68ca0b7a4225a66a636e1d1}{eventsread}}\ >=\ options.breakatevent)\ \{}
...
\DoxyCodeLine{\Hypertarget{process_8cc_source_l00280}00280\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a9290c324fdbec0c231d1f4dbc34dd402}{eof}}()\ ||\ reader-\/>\doxymbox{\hyperlink{class_p_i_x_i_e_1_1_reader_a9e1ef7766d3ee935ff0b384d52d6a87c}{end}})\ \{}
