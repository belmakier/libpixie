...
Definition at line \mbox{\hyperlink{event_8cc_source_l00181}{181}} of file \mbox{\hyperlink{event_8cc_source}{event.\+cc}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00181                                        \{}
\DoxyCodeLine{00182     Measurement *meas = \&(reader-\/>measurements[\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a93932ad5d16872467ad4a5a3e44cfaa3}{fMeasurements}}[\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ad39077e66bf9468214071572181d7bb1}{nMeas}}-\/1]]);}
\DoxyCodeLine{00183     \textcolor{keywordtype}{int} retval = meas-\/>read\_full(reader);}
\DoxyCodeLine{00184     \textcolor{comment}{//at this point we know that this belongs in the event}}
\DoxyCodeLine{00185     \textcolor{keywordflow}{if} (meas-\/>finishCode == 1) \{}
\DoxyCodeLine{00186       ++\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a973b89428d1117d52568424015f327aa}{pileups}};}
\DoxyCodeLine{00187     \}}
\DoxyCodeLine{00188 }
\DoxyCodeLine{00189     \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ab4034a1f813be7192c14143d76040d6d}{badcfd}} += meas-\/>CFDForce;}
\DoxyCodeLine{00190     \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a1fa2c3028bd5b4b432d34e2c3319c8b9}{outofrange}} += meas-\/>outOfRange;   }
\DoxyCodeLine{00191       }
\DoxyCodeLine{00192     \textcolor{keywordflow}{return} retval;}
\DoxyCodeLine{00193   \}}
...
Definition at line \mbox{\hyperlink{event_8cc_source_l00169}{169}} of file \mbox{\hyperlink{event_8cc_source}{event.\+cc}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00169                                          \{}
\DoxyCodeLine{00170     \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a93932ad5d16872467ad4a5a3e44cfaa3}{fMeasurements}}[\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ad39077e66bf9468214071572181d7bb1}{nMeas}}] = reader-\/>measCtr;}
\DoxyCodeLine{00171     Measurement *meas = \&(reader-\/>measurements[reader-\/>measCtr]);}
\DoxyCodeLine{00172     \textcolor{keywordtype}{int} retval = meas-\/>read\_header(reader);}
\DoxyCodeLine{00173       }
\DoxyCodeLine{00174     ++\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ad39077e66bf9468214071572181d7bb1}{nMeas}};}
\DoxyCodeLine{00175     ++reader-\/>measCtr;}
\DoxyCodeLine{00176     \textcolor{keywordflow}{if} (reader-\/>measCtr == \mbox{\hyperlink{definitions_8hh_a4440d694835967b63cafe00ad888c327}{MAX\_MEAS\_PER\_EVENT}} * \mbox{\hyperlink{definitions_8hh_ae42954bb8545d24e3e9dcde5920c9a0b}{MAX\_EVENTS}}) \{}
\DoxyCodeLine{00177       reader-\/>measCtr = 0;}
\DoxyCodeLine{00178     \}}
\DoxyCodeLine{00179     \textcolor{keywordflow}{return} retval;}
\DoxyCodeLine{00180   \}}
...
Definition at line \mbox{\hyperlink{event_8cc_source_l00160}{160}} of file \mbox{\hyperlink{event_8cc_source}{event.\+cc}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00160                                           \{}
\DoxyCodeLine{00161     \textcolor{keywordtype}{int} retval = \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a435968180a70e7b86a828e7f7fc1bf42}{AddMeasHeader}}(reader);}
\DoxyCodeLine{00162     \textcolor{keywordflow}{if} (retval == -\/1) \{}
\DoxyCodeLine{00163       \textcolor{keywordflow}{return} retval;}
\DoxyCodeLine{00164     \}}
\DoxyCodeLine{00165       }
\DoxyCodeLine{00166     retval = \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a10e1f7b5ac95b7665ba578fb291686b0}{AddMeasFull}}(reader);}
...
Definition at line \mbox{\hyperlink{event_8cc_source_l00148}{148}} of file \mbox{\hyperlink{event_8cc_source}{event.\+cc}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00148                                                                                                            \{}
\DoxyCodeLine{00149     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ad39077e66bf9468214071572181d7bb1}{nMeas}}-\/1; ++i) \{}
\DoxyCodeLine{00150       \textcolor{keyword}{const} Measurement *meas = \&(reader-\/>measurements[\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a93932ad5d16872467ad4a5a3e44cfaa3}{fMeasurements}}[i]]);}
\DoxyCodeLine{00151       \textcolor{keywordflow}{if} (meas-\/>crateID == crateID \&\&}
\DoxyCodeLine{00152           meas-\/>slotID == slotID \&\&}
\DoxyCodeLine{00153           meas-\/>channelNumber == channelNumber) \{}
\DoxyCodeLine{00154         \textcolor{keywordflow}{return} meas;}
\DoxyCodeLine{00155       \}}
\DoxyCodeLine{00156     \}}
...
Definition at line \mbox{\hyperlink{event_8cc_source_l00195}{195}} of file \mbox{\hyperlink{event_8cc_source}{event.\+cc}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00195                                                                       \{}
\DoxyCodeLine{00196     \textcolor{keywordflow}{return} \&(reader-\/>measurements[\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a93932ad5d16872467ad4a5a3e44cfaa3}{fMeasurements}}[i]]);}
\DoxyCodeLine{00197   \}}
...
Definition at line \mbox{\hyperlink{event_8cc_source_l00133}{133}} of file \mbox{\hyperlink{event_8cc_source}{event.\+cc}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00134   \{}
\DoxyCodeLine{00135     std::cout << \textcolor{stringliteral}{"{}======= NEW EVENT ======"{}} << std::endl;}
\DoxyCodeLine{00136     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ad39077e66bf9468214071572181d7bb1}{nMeas}}; ++i) \{}
\DoxyCodeLine{00137       std::cout << \textcolor{stringliteral}{"{}index = "{}} << \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a93932ad5d16872467ad4a5a3e44cfaa3}{fMeasurements}}[i] << std::endl;}
\DoxyCodeLine{00138       reader-\/>measurements[\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a93932ad5d16872467ad4a5a3e44cfaa3}{fMeasurements}}[i]].print();}
\DoxyCodeLine{00139     \}}
\DoxyCodeLine{00140     std::cout << \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a973b89428d1117d52568424015f327aa}{pileups}} << std::endl;}
\DoxyCodeLine{00141     std::cout << \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ab4034a1f813be7192c14143d76040d6d}{badcfd}} << std::endl;}
\DoxyCodeLine{00142     std::cout << \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a1fa2c3028bd5b4b432d34e2c3319c8b9}{outofrange}} << std::endl;}
\DoxyCodeLine{00143     }
...
\DoxyCodeLine{00094           std::cout<< \mbox{\hyperlink{colors_8hh_a34995b955465f6bbb37c359173d50477}{ANSI\_COLOR\_RED}} \textcolor{stringliteral}{"{}\(\backslash\)nWarning! File is not properly time-\/sorted"{}} << std::endl;}
\DoxyCodeLine{00095           std::cout<< \textcolor{stringliteral}{"{}First event: "{}}}
\DoxyCodeLine{00096                    << lastCrate << \textcolor{stringliteral}{"{}."{}} }
\DoxyCodeLine{00097                    << lastSlot << \textcolor{stringliteral}{"{}."{}} }
\DoxyCodeLine{00098                    << lastChan << \textcolor{stringliteral}{"{}   "{}} << maxTime -\/ coincWindow << std::endl;}
\DoxyCodeLine{00099           std::cout<< \textcolor{stringliteral}{"{}Second event: "{}}}
\DoxyCodeLine{00100                    << next\_meas-\/>crateID << \textcolor{stringliteral}{"{}."{}}}
\DoxyCodeLine{00101                    << next\_meas-\/>slotID << \textcolor{stringliteral}{"{}."{}}}
\DoxyCodeLine{00102                    << next\_meas-\/>channelNumber << \textcolor{stringliteral}{"{}   "{}} << next\_meas-\/>eventTime << \mbox{\hyperlink{colors_8hh_a92a364c2b863dde1a024a77eac2a5b3b}{ANSI\_COLOR\_RESET}} << std::endl;}
\DoxyCodeLine{00103 }
\DoxyCodeLine{00104         \}}
\DoxyCodeLine{00105                 }
\DoxyCodeLine{00106         lastCrate = next\_meas-\/>crateID;}
\DoxyCodeLine{00107         lastSlot = next\_meas-\/>slotID;}
\DoxyCodeLine{00108         lastChan = next\_meas-\/>channelNumber;}
\DoxyCodeLine{00109         \textcolor{keyword}{auto} *channel = reader-\/>definition.GetChannel(next\_meas-\/>crateID, next\_meas-\/>slotID, next\_meas-\/>channelNumber);}
\DoxyCodeLine{00110         \textcolor{keywordflow}{if} (channel-\/>extwind) \{}
\DoxyCodeLine{00111           maxTime = next\_meas-\/>eventTime+coincWindow;}
\DoxyCodeLine{00112         \}}
\DoxyCodeLine{00113         \textcolor{comment}{//go to next sub-\/event}}
\DoxyCodeLine{00114 }
\DoxyCodeLine{00115         \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_p_i_x_i_e_1_1_event_a0164d55be13b1246c33fada1f298a2c0}{mult}} == \mbox{\hyperlink{definitions_8hh_a4440d694835967b63cafe00ad888c327}{MAX\_MEAS\_PER\_EVENT}}-\/1) \{}
\DoxyCodeLine{00116           retval = 2;}
\DoxyCodeLine{00117           \textcolor{keywordflow}{break};}
\DoxyCodeLine{00118         \}}
\DoxyCodeLine{00119       \}}
\DoxyCodeLine{00120       \textcolor{keywordflow}{else} \{        }
\DoxyCodeLine{00121         curEvent=0; \textcolor{comment}{//breaks current event loop}}
\DoxyCodeLine{00122       \}}
\DoxyCodeLine{00123     \}\textcolor{comment}{//loop for current event}}
\DoxyCodeLine{00124 }
\DoxyCodeLine{00125     \textcolor{comment}{//average event length}}
\DoxyCodeLine{00126     reader-\/>av\_evt\_length = (reader-\/>av\_evt\_length*reader-\/>nEvents + ((maxTime-\/triggerTime)/(3276.8*1e3)))/(double)(reader-\/>nEvents + 1);}
\DoxyCodeLine{00127     }
\DoxyCodeLine{00128     \mbox{\hyperlink{class_p_i_x_i_e_1_1_event_ad39077e66bf9468214071572181d7bb1}{nMeas}} -\/= 1; \textcolor{comment}{//not in this event}}
\DoxyCodeLine{00129     }
\DoxyCodeLine{00130     \textcolor{keywordflow}{return} retval;}
\DoxyCodeLine{00131   \}}
